...
GenGC_HDRL0=0	--> start of old area
GenGC_HDRL1=4   --> start of reserve area
GenGC_HDRL2=8   --> start of word area
GenGC_HDRL3=12  --> end of old area
GenGC_HDRL4=16  --> heap limit
...
GenGC_HDRSIZE=44				# size of GenGC header
	# 0  --> start of old area
	# 4  --> start of reserve area
	# 8  --> start of word area
	# 12 --> end of old area
	# 16 --> heap limit
